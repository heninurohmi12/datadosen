...
<head>
    ...
    <title>Data Dosen @yield("title")</title>
...
<body>
    <nav class="navbar navbar-expand p-0">
        <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="index.html"> Data Dosen </a>
    ...
    <div class="container-fluid h-100 p-0">
        ...
        mb-4" type="text" placeholder="Search" aria-label="Search" />
                    ...
                    <li>
                        <a href="#">
                            <span class="oi oi-people"></span> Nama Dosen
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span class="oi oi-book"></span> Mata Kuliah
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span class="oi oi-clock"></span> Jam MK
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span class="oi oi-home"></span> Ruang MK
                        </a>
                    </li>
